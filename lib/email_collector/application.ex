defmodule EmailCollector.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: EmailCollector.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    EmailCollectorWeb.Endpoint.config_change(changed, removed)
    :ok
  end
