...
#
#     PHX_SERVER=true bin/email_collector start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :email_collector, EmailCollectorWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/email_collector/email_collector.db
      """
  ...
  host = System.get_env("PHX_HOST") || "email-collection.com"
